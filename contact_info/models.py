...
class Address(models.Model):
    ...
    def __str__(self):
        return " ".join(filter(None, [", ".join(filter(None, [self.address1, self.address2, self.city, self.state.abbreviation])), self.postal_code]))
...
class Person(models.Model):
    ...
    phone_numbers = models.ManyToManyField(Phone, null=True, blank=True)
